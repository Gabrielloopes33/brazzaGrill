...
const reviews: Review[] = [
  {
    ...
    rating: 5,
    text: 'Best burger I\'ve had in Fort Myers! The Brazilian flavors are incredible and the service is always friendly. Highly recommend the Brazza Classic!',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Perfect late-night food! The Fort Myers Heat burger lives up to its name - super spicy and delicious. Worth the heat!',
